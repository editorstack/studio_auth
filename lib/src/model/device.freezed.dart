...
mixin _$Device {
 ...
 String get id => throw _privateConstructorUsedError; String get name => throw _privateConstructorUsedError; DeviceType get type => throw _privateConstructorUsedError; String get userID => throw _privateConstructorUsedError; DateTime get createdAt => throw _privateConstructorUsedError; DateTime get lastSignedInAt => throw _privateConstructorUsedError;
...
@useResult
$Res call({
 String id, String name, DeviceType type, String userID, DateTime createdAt, DateTime lastSignedInAt
});
...
/// Create a copy of Device
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? type = null,Object? userID = null,Object? createdAt = null,Object? lastSignedInAt = null,}) {
...
class _$DeviceImpl  implements _Device {
  const _$DeviceImpl({required this.id, required this.name, required this.type, required this.userID, required this.createdAt, required this.lastSignedInAt});
...
@override
String toString() {
  return 'Device(id: $id, name: $name, type: $type, userID: $userID, createdAt: $createdAt, lastSignedInAt: $lastSignedInAt)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,type,userID,createdAt,lastSignedInAt);
...
abstract class _Device implements Device {
  const factory _Device({required final  String id, required final  String name, required final  DeviceType type, required final  String userID, required final  DateTime createdAt, required final  DateTime lastSignedInAt}) = _$DeviceImpl;
  

  factory _Device.fromJson(Map<String, dynamic> json) = _$DeviceImpl.fromJson;

@override String get id;@override String get name;@override DeviceType get type;@override String get userID;@override DateTime get createdAt;@override DateTime get lastSignedInAt;
/// Create a copy of Device
/// with the given fields replaced by the non-null parameter values.
