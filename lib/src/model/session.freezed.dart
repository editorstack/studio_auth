...
mixin _$Session {
 ...
 String get id => throw _privateConstructorUsedError; String get identityID => throw _privateConstructorUsedError; String? get deviceID => throw _privateConstructorUsedError; String get userID => throw _privateConstructorUsedError; String get token => throw _privateConstructorUsedError; String get appID => throw _privateConstructorUsedError; bool get valid => throw _privateConstructorUsedError; DateTime? get expiresAt => throw _privateConstructorUsedError; String? get ipAddress => throw _privateConstructorUsedError;
...
@useResult
$Res call({
 String id, String identityID, String? deviceID, String userID, String token, String appID, bool valid, DateTime? expiresAt, String? ipAddress
});
...
/// Create a copy of Session
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? identityID = null,Object? deviceID = freezed,Object? userID = null,Object? token = null,Object? appID = null,Object? valid = null,Object? expiresAt = freezed,Object? ipAddress = freezed,}) {
...
class _$SessionImpl  implements _Session {
  const _$SessionImpl({required this.id, required this.identityID, required this.deviceID, required this.userID, required this.token, required this.appID, required this.valid, required this.expiresAt, required this.ipAddress});
...
@override
String toString() {
  return 'Session(id: $id, identityID: $identityID, deviceID: $deviceID, userID: $userID, token: $token, appID: $appID, valid: $valid, expiresAt: $expiresAt, ipAddress: $ipAddress)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,identityID,deviceID,userID,token,appID,valid,expiresAt,ipAddress);
...
@override String get id;@override String get identityID;@override String? get deviceID;@override String get userID;@override String get token;@override String get appID;@override bool get valid;@override DateTime? get expiresAt;@override String? get ipAddress;
/// Create a copy of Session
/// with the given fields replaced by the non-null parameter values.
...
mixin _$AuthSession {
 ...
 String get id => throw _privateConstructorUsedError; String get identityID => throw _privateConstructorUsedError; String? get deviceID => throw _privateConstructorUsedError; String get userID => throw _privateConstructorUsedError; String get token => throw _privateConstructorUsedError; String get appID => throw _privateConstructorUsedError; bool get valid => throw _privateConstructorUsedError; DateTime? get expiresAt => throw _privateConstructorUsedError; String? get ipAddress => throw _privateConstructorUsedError; Auth get auth => throw _privateConstructorUsedError;
...
@useResult
$Res call({
 String id, String identityID, String? deviceID, String userID, String token, String appID, bool valid, DateTime? expiresAt, String? ipAddress, Auth auth
});
...
/// Create a copy of AuthSession
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? identityID = null,Object? deviceID = freezed,Object? userID = null,Object? token = null,Object? appID = null,Object? valid = null,Object? expiresAt = freezed,Object? ipAddress = freezed,Object? auth = null,}) {
  return _then(_value.copyWith(
id: null == id ? _value.id : id // ignore: cast_nullable_to_non_nullable
as String,identityID: null == identityID ? _value.identityID : identityID // ignore: cast_nullable_to_non_nullable
as String,deviceID: freezed == deviceID ? _value.deviceID : deviceID // ignore: cast_nullable_to_non_nullable
...
class _$AuthSessionImpl  implements _AuthSession {
  const _$AuthSessionImpl({required this.id, required this.identityID, required this.deviceID, required this.userID, required this.token, required this.appID, required this.valid, required this.expiresAt, required this.ipAddress, required this.auth});
...
@override
String toString() {
  return 'AuthSession(id: $id, identityID: $identityID, deviceID: $deviceID, userID: $userID, token: $token, appID: $appID, valid: $valid, expiresAt: $expiresAt, ipAddress: $ipAddress, auth: $auth)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,identityID,deviceID,userID,token,appID,valid,expiresAt,ipAddress,auth);
...
@override String get id;@override String get identityID;@override String? get deviceID;@override String get userID;@override String get token;@override String get appID;@override bool get valid;@override DateTime? get expiresAt;@override String? get ipAddress;@override Auth get auth;
/// Create a copy of AuthSession
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
